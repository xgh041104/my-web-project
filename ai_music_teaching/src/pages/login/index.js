...
import {
  Button, Row, Col, Form, Input, Alert, Card,
  Spin, Layout, Modal, Checkbox, Space, Typography
} from 'antd'
...
const Login = ({
  ...
  const styles = {
    ...
    glowingOrb: {
      ...
      height: '300px',
      borderRadius: '50%',
      background: 'radial-gradient(circle, rgba(126,178,255,0.4) 0%, rgba(249,250,255,0) 70%)',
      top: '50%',
      left: '50%',
  ...
  return (
    <div style={styles.background}>
        ...
        <>
          <div div style={audioVisualizerBackground}>
              ...
              {Array(20).fill(null).map((_, i) => (
                <div
                  ...
                  style={{
                    ...
                    background: 'linear-gradient(0deg, rgba(126,178,255,0.7) 0%, rgba(147,192,255,0.3) 100%)',
            ...
            <div style={waveContainer}>
              <svg width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 1440 320">
                <path
          ...
          <div style={styles.heroSection}>
            <div style={styles.heroContent}>
              ...
              <Paragraph style={styles.subtitle}>
                基于<span style={styles.highlight}>多模态大模型</span>的AI智慧音乐教育平台
              </Paragraph>
            </div>
          </div>
            ...
            <Row gutter={[24, 24]} justify="center">
              {modules.map((mod, index) => (
                <Col xs={24} sm={12} md={8} key={index} >
                  ...
                  ><Row justify="center" align="middle" style={{ marginTop: '26px' }}>
                      <Col >
                        <div style={styles.featureIcon}>{mod.icon}</div>
                      </Col>
                      <Col span={14}>
                        <Title level={4} style={styles.featureTitle}>{mod.title}</Title>
                      </Col>
                    </Row>
                  </Card>
                </Col>
      ...
      {/* 框架插入 */}
      {
        isManageSystem && <div style={{ zIndex: '1000', overflow: 'hidden' }}>
          <iframe style={{ width: '100vw', height: '100vh', border: '0' }}
            src={baseUrl + 'http://localhost:8001/login'}
      ...
      {
        isExamSystem && <div style={{ zIndex: '1000', overflow: 'hidden' }}>
          <iframe style={{ width: '100vw', height: '100vh', border: '0' }}
