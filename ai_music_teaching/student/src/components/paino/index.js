            ...
            return (
              <div key={index} className="piano-key">                 
                <div data-type="white" ref={e => { refs.current[item.white.keyCode] = e }} className="piano-key__white"
                  onMouseDown={() => playNote(true,item.white.keyCode)}
                  onTouchStart={() => playNote(true,item.white.keyCode)}
                  onMouseUp={() => playNote(false,item.white.keyCode)}
                  onTouchEnd={() => playNote(false,item.white.keyCode)}
                ...
                }} className="piano-key__black" onMouseDown={() => playNote(true,item.black.keyCode)} data-key={item.black.keyCode}
                  onMouseUp={() => playNote(false,item.black.keyCode)}
                  onTouchStart={() => playNote(true,item.black.keyCode)}
